# setup the 13 parameters that are needed for the evolution process:
...
#    ObjectiveNames - list containing the names of the objectives (default =  c("AverageNodesScore", "Density"))
#    ThresholdSignificantlyDEGenes (default = 0.05)
#    MaxNumberOfAttempts (default = 3)
#    Measure (default = "FDR")
#    NumberOfRunsToExecute (default = 1)
mogamun.init(Generations=3)

# define the data to be loaded for the run:
#    DifferentialExpressionPath - full path to the differential expression results file (in CSV format). This file must contain It must contain at least the columns "gene" with the gene names, and ("PValue" or "FDR"). It can also contain "logFC"
...
mogamun.load.data(DifferentialExpressionPath = "C:/Users/User/Documents/My_Experiment/Differential_Expression_Results.csv",
...
mogamun.run(resultsDir = "C:/Users/User/Documents/My_Experiment/MOGAMUN_Results/")
